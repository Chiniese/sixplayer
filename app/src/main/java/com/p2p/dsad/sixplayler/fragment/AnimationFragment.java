...
public class AnimationFragment extends BaseFragment {
    ...
    @Bind(R.id.recycler_animation_view)
    RecyclerView recyclerAnimationView;
    ...
    private void confingRecycler()
    {
        ...
        recyclerAnimationView.setItemAnimator(new DefaultItemAnimator());
        recyclerAnimationView.setLayoutManager(new StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.VERTICAL));
        recyclerAnimationView.addItemDecoration(new RecyclerViewItemSpace(16));
        recyclerAnimationView.setAdapter(myadpter);
