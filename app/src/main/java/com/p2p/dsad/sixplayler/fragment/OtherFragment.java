...
public class OtherFragment extends BaseFragment {
    ...
    @Bind(R.id.recycler_other_view)
    RecyclerView recyclerOtherView;
    ...
    private void confingRecycler()
    {
        ...
        recyclerOtherView.setItemAnimator(new DefaultItemAnimator());
        recyclerOtherView.setLayoutManager(new StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.VERTICAL));
        recyclerOtherView.addItemDecoration(new RecyclerViewItemSpace(16));
        recyclerOtherView.setAdapter(myadpter);
